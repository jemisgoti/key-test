...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1819: x0 => x0.length,
      _1821: (x0,x1) => x0[x1],
      _1822: (x0,x1,x2) => x0[x1] = x2,
      _1825: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1827: x0 => new Int8Array(x0),
      _1828: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1829: x0 => new Uint8Array(x0),
      _1837: x0 => new Int32Array(x0),
      _1841: x0 => new Float32Array(x0),
      _1843: x0 => new Float64Array(x0),
      _1875: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1876: () => new TextDecoder("utf-8", {fatal: true}),
      _1877: () => new TextDecoder("utf-8", {fatal: false}),
      _1878: x0 => new WeakRef(x0),
      _1879: x0 => x0.deref(),
      _1885: Date.now,
      _1887: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1888: s => {
      ...
      _1890: () => typeof dartUseDateNowForTicks !== "undefined",
      _1891: () => 1000 * performance.now(),
      _1892: () => Date.now(),
      _1895: () => new WeakMap(),
      _1896: (map, o) => map.get(o),
      _1897: (map, o, v) => map.set(o, v),
      _1898: () => globalThis.WeakRef,
      _1909: s => JSON.stringify(s),
      _1910: s => printToConsole(s),
      _1911: a => a.join(''),
      _1914: (s, t) => s.split(t),
      _1915: s => s.toLowerCase(),
      _1916: s => s.toUpperCase(),
      _1917: s => s.trim(),
      _1918: s => s.trimLeft(),
      _1919: s => s.trimRight(),
      _1921: (s, p, i) => s.indexOf(p, i),
      _1922: (s, p, i) => s.lastIndexOf(p, i),
      _1924: Object.is,
      _1925: s => s.toUpperCase(),
      _1926: s => s.toLowerCase(),
      _1927: (a, i) => a.push(i),
      _1931: a => a.pop(),
      _1932: (a, i) => a.splice(i, 1),
      _1934: (a, s) => a.join(s),
      _1935: (a, s, e) => a.slice(s, e),
      _1938: a => a.length,
      _1940: (a, i) => a[i],
      _1941: (a, i, v) => a[i] = v,
      _1943: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1944: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1945: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1946: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1947: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1948: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1949: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1954: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1955: (t, s) => t.set(s),
      _1957: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1959: o => o.buffer,
      _1960: o => o.byteOffset,
      _1961: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1962: (b, o) => new DataView(b, o),
      _1963: (b, o, l) => new DataView(b, o, l),
      _1964: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1965: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1966: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1967: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1968: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1969: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1970: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1971: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1972: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1973: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1974: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1975: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1978: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1979: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1980: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1981: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1982: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1983: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1996: (o, t) => o instanceof t,
      ...
      _2000: o => Object.keys(o),
      _2001: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _2002: (handle) => clearTimeout(handle),
      _2003: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _2004: (handle) => clearInterval(handle),
      _2005: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _2006: () => Date.now(),
      _2038: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2038(f,arguments.length,x0) }),
      _2054: () => globalThis.Module_soloud.wasmWorker,
      _2170: (s, m) => {
        try {
      ...
      _2171: (x0,x1) => x0.exec(x1),
      _2172: (x0,x1) => x0.test(x1),
      _2173: (x0,x1) => x0.exec(x1),
      _2174: (x0,x1) => x0.exec(x1),
      _2175: x0 => x0.pop(),
      _2177: o => o === undefined,
      _2196: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2198: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2199: o => o instanceof RegExp,
      _2200: (l, r) => l === r,
      _2201: o => o,
      _2202: o => o,
      _2203: o => o,
      ...
      _2205: o => o.length,
      _2208: (o, i) => o[i],
      _2209: f => f.dartFunction,
      _2210: l => arrayFromDartList(Int8Array, l),
      _2211: l => arrayFromDartList(Uint8Array, l),
      _2212: l => arrayFromDartList(Uint8ClampedArray, l),
      _2213: l => arrayFromDartList(Int16Array, l),
      _2214: l => arrayFromDartList(Uint16Array, l),
      _2215: l => arrayFromDartList(Int32Array, l),
      _2216: l => arrayFromDartList(Uint32Array, l),
      _2217: l => arrayFromDartList(Float32Array, l),
      _2218: l => arrayFromDartList(Float64Array, l),
      _2219: x0 => new ArrayBuffer(x0),
      _2220: (data, length) => {
      ...
      _2221: l => arrayFromDartList(Array, l),
      _2222: () => ({}),
      _2223: () => [],
      _2224: l => new Array(l),
      _2225: () => globalThis,
      _2226: (constructor, args) => {
      ...
      _2228: (o, p) => o[p],
      _2229: (o, p, v) => o[p] = v,
      _2230: (o, m, a) => o[m].apply(o, a),
      _2232: o => String(o),
      _2233: (p, s, f) => p.then(s, f),
      _2234: o => {
      ...
      _2239: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _2240: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI32ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _2241: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2244: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2248: x0 => x0.index,
      _2253: x0 => x0.flags,
      _2254: x0 => x0.multiline,
      _2255: x0 => x0.ignoreCase,
      _2256: x0 => x0.unicode,
      _2257: x0 => x0.dotAll,
      _2258: (x0,x1) => x0.lastIndex = x1,
      _2260: (o, p) => o[p],
      _2263: x0 => x0.random(),
      _2264: x0 => x0.random(),
      _2268: () => globalThis.Math,
      _2270: Function.prototype.call.bind(Number.prototype.toString),
      _2271: (d, digits) => d.toFixed(digits),
      _4652: x0 => x0.data,
      _4767: (x0,x1) => x0.onmessage = x1,
